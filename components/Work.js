...
const Card2 = ({ title,subtitle, description, icons ,duration}) => {
	return (
		<div className="card py-3 px-3 mx-sm-4 my-4 card-work" style={{ width: "25rem" }}>
			<h4 className="text-primary">{title}</h4>
...
export const Experience = ({ title, cards }) => {
	return (
		<div id="experience" className="bg-primary py-5 px-5">
			<div className="container">
